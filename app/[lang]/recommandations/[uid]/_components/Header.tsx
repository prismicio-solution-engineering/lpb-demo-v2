...
export default function Header({data}:{data:Simplify<RecapDocumentData>}) {
      ...
      <Container size="xl" className="flex justify-between items-center gap-8 relative">
        ...
        <div className="w-full hidden lg:flex justify-between items-center gap-8">
          ...
          {isFilled.link(data.header_button) && (
              <PrismicNextLink field={data.header_button} className="flex items-center cursor-pointer group">
                <svg width="32" height="32" viewBox="0 0 64 64" fill="#FF0000" xmlns="http://www.w3.org/2000/svg" className="mr-2">
                    <path opacity="0.2" d="M0 16C0 7.16344 7.16344 0 16 0H48C56.8366 0 64 7.16344 64 16V48C64 56.8366 56.8366 64 48 64H16C7.16344 64 0 56.8366 0 48V16Z" fill="#FFFFFF"/>
                    <path d="M26 16C27.1063 16 28 16.8937 28 18V20H36V18C36 16.8937 36.8938 16 38 16C39.1063 16 40 16.8937 40 18V20H43C44.6562 20 46 21.3438 46 23V26H18V23C18 21.3438 19.3438 20 21 20H24V18C24 16.8937 24.8938 16 26 16ZM18 28H46V45C46 46.6562 44.6562 48 43 48H21C19.3438 48 18 46.6562 18 45V28ZM22 33V35C22 35.55 22.45 36 23 36H25C25.55 36 26 35.55 26 35V33C26 32.45 25.55 32 25 32H23C22.45 32 22 32.45 22 33ZM30 33V35C30 35.55 30.45 36 31 36H33C33.55 36 34 35.55 34 35V33C34 32.45 33.55 32 33 32H31C30.45 32 30 32.45 30 33ZM39 32C38.45 32 38 32.45 38 33V35C38 35.55 38.45 36 39 36H41C41.55 36 42 35.55 42 35V33C42 32.45 41.55 32 41 32H39ZM22 41V43C22 43.55 22.45 44 23 44H25C25.55 44 26 43.55 26 43V41C26 40.45 25.55 40 25 40H23C22.45 40 22 40.45 22 41ZM31 40C30.45 40 30 40.45 30 41V43C30 43.55 30.45 44 31 44H33C33.55 44 34 43.55 34 43V41C34 40.45 33.55 40 33 40H31ZM38 41V43C38 43.55 38.45 44 39 44H41C41.55 44 42 43.55 42 43V41C42 40.45 41.55 40 41 40H39C38.45 40 38 40.45 38 41Z" fill="#A4A4A4"/>
                </svg>
                {data.header_button.text ? data.header_button.text : "Request a demo"}
              </PrismicNextLink>
          )}
        </div>

        {/* 4. Bouton Burger Mobile */}
        <div 
        ...
        >
            ...
            <svg 
              ...
              // Si menu ouvert : opacity-100 et rotation normale
              // Si menu fermé : opacity-0 et rotation -90deg (effet visuel sympa)
            ...
            <svg 
              ...
              fill="none" 
              xmlns="http://www.w3.org/2000/svg" 
              // Inverse de la croix : opacity-100 quand fermé
        ...
        {/* 5. Mobile Panel */}
        <div 
          // Gestion de la position avec 'left-0' (visible) ou 'left-full' (caché à droite)
          // Ajout de 'transition-all' pour l'animation de glissement
          className={`
            ...
            <div className="flex flex-col">
                ...
                <div className="max-w-3xl w-full mx-auto px-8 flex flex-col justify-center items-center">
                    ...
                    <a
                        key={link.id}
                        href={`#${link.id}`}
                        // On ferme le menu au clic sur un lien
                        onClick={() => handleLinkClick(link.id)}
