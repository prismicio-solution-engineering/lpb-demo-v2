      ...
      <Container size="xl" className="flex justify-between items-center gap-8 relative">
        ...
        <div className="w-full hidden lg:flex justify-between items-center gap-8">
          <div className="relative flex items-center gap-2 text-[rgba(80,80,80,0.8)] py-6 font-medium">
            ...
            <a href="https://prismic.io/demo" target="_blank" rel="noreferrer" className="flex items-center cursor-pointer group">
                ...
                <span className="text-[#505050]">Request a demo</span>
            </a>
        </div>
