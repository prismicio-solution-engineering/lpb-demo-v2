...
const EcommerceHeader = ({ page }: { page: EcommerceDocument }) => {
  ...
  return (
    <header
      className="z-10 fixed flex flex-col justify-center items-center bg-white py-4 w-screen"
      style={
        {
    ...
    >
      <Container className="relative">
        <div className="flex justify-center items-center">
          <div className="left-5 absolute flex items-center gap-2">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
              <path
                ...
                class="common__StyledPath-sc-1slhoh2-0 jLOGiE"
                fill="#1D2424"
              ></path>
            </svg>
            <input
