...
export default function Quote({ className }: Props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="32px" height="32px" viewBox="0 0 64 64" fill="currentColor" className={ className }>
            <g transform="scale(0.045) translate(200, 1200)">
