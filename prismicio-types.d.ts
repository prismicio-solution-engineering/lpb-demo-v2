...
interface ArticleDocumentData {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/content-relationship
	 */
	author: ContentRelationshipFieldWithData<[{"id":"author","fields":["img","name"]}]>;
...
interface ContactDocumentData {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	calendar: prismic.LinkField<string, string, unknown, prismic.FieldState, never>;
}
...
type EcommerceDocumentDataSlicesSlice = BannerSlice | ProductSelectionSlice | CarouselSlice | IconsSlice
...
interface EcommerceDocumentData {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	lnks: prismic.Repeatable<prismic.LinkField<string, string, unknown, prismic.FieldState, never>>;/**
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/select
	 */
	font_heading: prismic.SelectField<"Function Book" | "Arial Bold" | "Proxima Bold", "filled">;
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/select
	 */
	font_txt: prismic.SelectField<"Function Book" | "Helvetica" | "Inter", "filled">;
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/select
	 */
	button_style: prismic.SelectField<"Square" | "Medium rounded" | "Rounded", "filled">;
}
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type EcommerceDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<EcommerceDocumentData>, "ecommerce", Lang>;
...
interface HeaderDocumentData {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	ctas: prismic.Repeatable<prismic.LinkField<string, string, unknown, prismic.FieldState, "Primary" | "Secondary" | "Link">>;
...
interface LandingDocumentData {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	cta: prismic.LinkField<string, string, unknown, prismic.FieldState, "Primary" | "Secondary">;/**
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type LandingDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<LandingDocumentData>, "landing", Lang>;
...
export interface RecapDocumentDataKeyProblemItem {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/select
	 */
	icon: prismic.SelectField<"thunder" | "test" | "brand" | "smile" | "checkedCalendar" | "control", "filled">;
...
interface RecapDocumentData {
	 ...
	 */
	key_problem: prismic.GroupField<Simplify<RecapDocumentDataKeyProblemItem>>;/**
	 * Title field in *Recap*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
	 */
	opportunity: prismic.GroupField<Simplify<RecapDocumentDataOpportunityItem>>;/**
	 * Title field in *Recap*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type BannerSliceVariation1 = prismic.SharedSliceVariation<"variation1", Simplify<BannerSliceVariation1Primary>, never>;
...
export interface CarouselSliceDefaultPrimaryGrpItem {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/content-relationship
	 */
	article: ContentRelationshipFieldWithData<[{"id":"article","fields":["read_time","date","img","title","desc",{"id":"author","customtypes":[{"id":"author","fields":["img","name"]}]},{"id":"category","customtypes":[{"id":"category","fields":["name"]}]},"read_time_txt"]}]>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CarouselSliceVariation1 = prismic.SharedSliceVariation<"variation1", Simplify<CarouselSliceVariation1Primary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CarouselSliceVariation2 = prismic.SharedSliceVariation<"variation2", Simplify<CarouselSliceVariation2Primary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CarouselSliceVariation3 = prismic.SharedSliceVariation<"variation3", Simplify<CarouselSliceVariation3Primary>, never>;

/**
 * Slice variation for *Carousel*
 */
type CarouselSliceVariation = CarouselSliceDefault | CarouselSliceVariation1 | CarouselSliceVariation2 | CarouselSliceVariation3
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ContentSliceTwoColumns = prismic.SharedSliceVariation<"twoColumns", Simplify<ContentSliceTwoColumnsPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ContentSliceTwoColumnsImage = prismic.SharedSliceVariation<"twoColumnsImage", Simplify<ContentSliceTwoColumnsImagePrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ContentSliceQuote = prismic.SharedSliceVariation<"quote", Simplify<ContentSliceQuotePrimary>, never>;
...
export interface ContentSliceTwoColumnsImagesPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
	 */
	images: prismic.GroupField<Simplify<ContentSliceTwoColumnsImagesPrimaryImagesItem>>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ContentSliceTwoColumnsImages = prismic.SharedSliceVariation<"twoColumnsImages", Simplify<ContentSliceTwoColumnsImagesPrimary>, never>;

/**
 * Slice variation for *Content*
 */
type ContentSliceVariation = ContentSliceDefault | ContentSliceTwoColumns | ContentSliceTwoColumnsImage | ContentSliceQuote | ContentSliceTwoColumnsImages
...
export interface CtaSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	btns: prismic.Repeatable<prismic.LinkField<string, string, unknown, prismic.FieldState, "Primary" | "Secondary">>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CtaSliceVariation1 = prismic.SharedSliceVariation<"variation1", Simplify<CtaSliceVariation1Primary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CtaSliceVariation2 = prismic.SharedSliceVariation<"variation2", Simplify<CtaSliceVariation2Primary>, never>;

/**
 * Slice variation for *Cta*
 */
type CtaSliceVariation = CtaSliceDefault | CtaSliceVariation1 | CtaSliceVariation2
...
export interface FaqSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	btn: prismic.LinkField<string, string, unknown, prismic.FieldState, "Primary" | "Secondary">;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type FaqSliceVariation1 = prismic.SharedSliceVariation<"variation1", Simplify<FaqSliceVariation1Primary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type FaqSliceVariation2 = prismic.SharedSliceVariation<"variation2", Simplify<FaqSliceVariation2Primary>, never>;

/**
 * Slice variation for *Faq*
 */
type FaqSliceVariation = FaqSliceDefault | FaqSliceVariation1 | FaqSliceVariation2
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type FeaturedArticlesSliceDefault = prismic.SharedSliceVariation<"default", Simplify<FeaturedArticlesSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type FeaturedArticlesSlice = prismic.SharedSlice<"featured_articles", FeaturedArticlesSliceVariation>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type HeroHomeSliceDefault = prismic.SharedSliceVariation<"default", Record<string, never>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type HeroHomeSlice = prismic.SharedSlice<"hero_home", HeroHomeSliceVariation>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type HeroLandingSliceDefault = prismic.SharedSliceVariation<"default", Simplify<HeroLandingSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type HeroLandingSliceVariation1 = prismic.SharedSliceVariation<"variation1", Simplify<HeroLandingSliceVariation1Primary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type HeroLandingSliceVariation2 = prismic.SharedSliceVariation<"variation2", Simplify<HeroLandingSliceVariation2Primary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type HeroLandingSliceVariation3 = prismic.SharedSliceVariation<"variation3", Simplify<HeroLandingSliceVariation3Primary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type HeroLandingSliceVariation4 = prismic.SharedSliceVariation<"variation4", Simplify<HeroLandingSliceVariation4Primary>, never>;

/**
 * Slice variation for *HeroLanding*
 */
type HeroLandingSliceVariation = HeroLandingSliceDefault | HeroLandingSliceVariation1 | HeroLandingSliceVariation2 | HeroLandingSliceVariation3 | HeroLandingSliceVariation4
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type IconsSliceDefault = prismic.SharedSliceVariation<"default", Simplify<IconsSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type MediaFeatureSliceDefault = prismic.SharedSliceVariation<"default", Simplify<MediaFeatureSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type MediaFeatureSlice = prismic.SharedSlice<"media_feature", MediaFeatureSliceVariation>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type NavigationLinksSliceDefault = prismic.SharedSliceVariation<"default", Simplify<NavigationLinksSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type NavigationLinksSliceWithSublinks = prismic.SharedSliceVariation<"withSublinks", Simplify<NavigationLinksSliceWithSublinksPrimary>, never>;

/**
 * Slice variation for *NavigationLinks*
 */
type NavigationLinksSliceVariation = NavigationLinksSliceDefault | NavigationLinksSliceWithSublinks
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ProductSelectionSliceDefault = prismic.SharedSliceVariation<"default", Simplify<ProductSelectionSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type TestimonialsSliceVariation1 = prismic.SharedSliceVariation<"variation1", Simplify<TestimonialsSliceVariation1Primary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type TestimonialsSliceVariation2 = prismic.SharedSliceVariation<"variation2", Simplify<TestimonialsSliceVariation2Primary>, never>;

/**
 * Slice variation for *Testimonials*
 */
type TestimonialsSliceVariation = TestimonialsSliceDefault | TestimonialsSliceVariation1 | TestimonialsSliceVariation2
