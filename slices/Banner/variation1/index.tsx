...
const Banner: FC<BannerProps> = ({ slice, context }) => {
  ...
  return (
    <section
      ...
      className="group relative my-20 py-20 min-h-125"
      style={
        {
    ...
    >
      <Container>
        <PrismicNextLink field={slice.primary.lnk}>
          ...
          />
          <div className="top-1/2 right-33 absolute flex flex-col gap-2 bg-neutral-50/80 p-12 max-w-70 -translate-y-1/2">
            <PrismicRichText
