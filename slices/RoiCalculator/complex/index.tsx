...
import { DefaultRoiCalculator as CalculatorUI } from "@/tools/roi/components/DefaultRoiCalculator";

export type RoiCalculatorProps = SliceComponentProps<Content.RoiCalculatorSlice>;

const ComplexRoiCalculator: FC<RoiCalculatorProps> = ({ slice }) => {
...
export default ComplexRoiCalculator;